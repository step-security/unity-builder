...
vi.mock('../../providers/provider-git-manager', async (importOriginal) => {
  const originalModule = await importOriginal<typeof import('../../providers/provider-git-manager')>();
...
const mockProviderGitManager = ProviderGitManager as import('vitest').Mocked<typeof ProviderGitManager>;
